          ...
          <div className="p-6 ">
            ...
            <form onSubmit={handleAddBook}>
              <div className="mb-4 ">
                ...
                <input required type="text" value={title} onChange={(e) => setTitle(e.target.value)} placeholder='Book Title' className='w-full px-4 py-2 border-2 border-black rounded-md' />
              </div>

              <div className="mb-4 ">
                <label className='block text-gray-900 font-medium'>Book Author</label>
                <input required type="text" value={author} onChange={(e) => setAuthor(e.target.value)} placeholder='Book Author' className='w-full px-4 py-2 border-2 border-black rounded-md' />
              </div>

              <div className="mb-4 ">
                <label className='block text-gray-900 font-medium'>Book Price (Price for borrowing)</label>
                <input required type="number" value={price} onChange={(e) => setPrice(e.target.value)} placeholder='Book Price' className='w-full px-4 py-2 border-2 border-black rounded-md' />
              </div>

              <div className="mb-4 ">
                <label className='block text-gray-900 font-medium'>Quantity</label>
                <input required type="number" value={quantity} onChange={(e) => setQuantity(e.target.value)} placeholder='Book Quantity' className='w-full px-4 py-2 border-2 border-black rounded-md' />
              </div>
