        ...
        <div className="p-6">
          ...
          <form onSubmit={handleUpdatePassword}>
            ...
            <div className="mb-4 sm:flex gap-4 items-center ">
              <label className="block to-gray-900 font-medium w-full">Current Password</label>
              <input type="password" value={currentPassword} onChange={(e) => setCurrentPassword(e.target.value)} placeholder="Enter Current Password" className="w-full px-4 py-2 border border-gray-300 rounded-md" />
            </div>

            <div className="mb-4 sm:flex gap-4 items-center ">
              <label className="block to-gray-900 font-medium w-full">New Password</label>
            ...
            <div className="mb-4 sm:flex gap-4 items-center  ">
              <label className="block to-gray-900 font-medium w-full">Confirm New Password</label>
            ...
            <div className="flex justify-end space-x-4">
              ...
              <div className="flex gap-4 mt-10">
                ...
                <button type="submit" disabled={loading} className="px-4 py-2 bg-black rounded-md hover:bg-gray-800 text-white">Update</button>
